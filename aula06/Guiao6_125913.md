...
![3b_logs](screenshots/3b_logs.png)
![3b_output_](screenshots/3b_output.png)

# Exercicio 4.

### a)
- O programa abre o diretório indicado (opendir), de seguida lê cada entrada ficheiro subdiretório, mostra o nome completo do ficheiro ou pasta. Ignora todos os ficheiros ocultos que comecem com ".". No final fecha o diretório.
